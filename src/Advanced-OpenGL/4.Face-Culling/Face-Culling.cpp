...
int main()
{
  ...
  glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    Shader litShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/4.Face-Culling/lit.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/4.Face-Culling/lit.fs").c_str());
    Shader unlitShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/4.Face-Culling/unlit.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/4.Face-Culling/unlit.fs").c_str());
    Shader lightCubeShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/4.Face-Culling/light_cube.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/4.Face-Culling/light_cube.fs").c_str());
