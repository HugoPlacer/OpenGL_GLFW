...
int main()
{
  ...
  glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    Shader litShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/lit.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/lit.fs").c_str());
    Shader unlitShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/unlit.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/unlit.fs").c_str());
    Shader lightCubeShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/light_cube.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/light_cube.fs").c_str());
    Shader singleColorShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/unlit.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-OpenGL/3.Blending/shaderSingleColor.fs").c_str());
    ...
    Model sponza("/home/hugo/Documentos/OpenGL_GLFW/assets/Sponza-master/sponza.obj");
    Model bunny("/home/hugo/Documentos/OpenGL_GLFW/assets/stanford-bunny.obj");

    vector<glm::vec3> bunnyPositions;
    bunnyPositions.push_back(glm::vec3(-1.5f,  0.0f, -0.48f));
    bunnyPositions.push_back(glm::vec3( 1.5f,  0.0f,  0.51f));
    bunnyPositions.push_back(glm::vec3( 0.0f,  0.0f,  0.7f));
    bunnyPositions.push_back(glm::vec3(-0.3f,  0.0f, -2.3f));
    bunnyPositions.push_back(glm::vec3( 0.5f,  0.0f, -0.6f));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            model = glm::translate(model, bunnyPositions[i] * glm::vec3(0.3));
            singleColorShader.setMat4("model", model);
            bunny.Draw(singleColorShader);
        }
