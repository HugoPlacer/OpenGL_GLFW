...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader((std::string(COMMON_SOURCE_DIR) + "/Lighting/6.Multiple-Lights/colors.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Lighting/6.Multiple-Lights/colors.fs").c_str());
    Shader lightCubeShader((std::string(COMMON_SOURCE_DIR) + "/Lighting/6.Multiple-Lights/light_cube.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Lighting/6.Multiple-Lights/light_cube.fs").c_str());
