...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader((std::string(COMMON_SOURCE_DIR) + "/Lighting/5.Light-Casters/colors.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Lighting/5.Light-Casters/colors.fs").c_str());
    Shader lightCubeShader((std::string(COMMON_SOURCE_DIR) + "/Lighting/5.Light-Casters/light_cube.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Lighting/5.Light-Casters/light_cube.fs").c_str());
...
glm::vec3(-1.3f,  1.0f, -1.5f)
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.use();
        lightingShader.setVec3("light.direction", -0.f, -1.0f, -0.3f);
