...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader((std::string(COMMON_SOURCE_DIR) + "/Lighting/4.Lighting-Maps/colors.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Lighting/4.Lighting-Maps/colors.fs").c_str());
    Shader lightCubeShader((std::string(COMMON_SOURCE_DIR) + "/Lighting/4.Lighting-Maps/light_cube.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Lighting/4.Lighting-Maps/light_cube.fs").c_str());
