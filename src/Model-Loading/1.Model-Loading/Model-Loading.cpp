...
int main()
{
  ...
  glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    Shader litShader((std::string(COMMON_SOURCE_DIR) + "/Model-Loading/1.Model-Loading/lit.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Model-Loading/1.Model-Loading/lit.fs").c_str());
    Shader unlitShader((std::string(COMMON_SOURCE_DIR) + "/Model-Loading/1.Model-Loading/unlit.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Model-Loading/1.Model-Loading/unlit.fs").c_str());
    Shader lightCubeShader((std::string(COMMON_SOURCE_DIR) + "/Model-Loading/1.Model-Loading/light_cube.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Model-Loading/1.Model-Loading/light_cube.fs").c_str());
