...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-Lighting/1.Advanced-Lighting/colors.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-Lighting/1.Advanced-Lighting/colors.fs").c_str());
    Shader lightCubeShader((std::string(COMMON_SOURCE_DIR) + "/Advanced-Lighting/1.Advanced-Lighting/light_cube.vs").c_str(),(std::string(COMMON_SOURCE_DIR) + "/Advanced-Lighting/1.Advanced-Lighting/light_cube.fs").c_str());
